...
if (fetchedCSS>=1) 
	console.log("There were " + fetchedCSS + " stylesheets requested to attempt to find more fonts.  You may need to rerun this script if you do not see all the fonts you are expecting");	
